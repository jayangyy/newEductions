...
<form id="search_users_form" style="text-align:left;">
    ...
    <input type="hidden" id="plan_status_cmt" name="plan_status_cmt" value="${officpEnumcmt}"/>
    <input type="hidden" id="plan_status" name="plan_status" value="${officpEnum}"/>
...
<!--所有自建计划批量移送，即处室移送-->
<table id="selectUsersGrid" class="easyui-datagrid" style="width:100%;height:40%"
       data-options="url:'getEmployeePage?searchType=0',method:'get',fitColumns:true,fit:false,idField:'em_idcard',checkbox:true,toolbar:'#tb4',pagination:true,pageNumber:1,pageSize:20,sortOrder:'DESC',sortName:'dwname',singleSelect:true">
    <thead>
        <tr>
...
<div id="tb4">
    <form id="search_users_grid_form">
...
<script type="text/javascript">
    ...
    {
        var formdata = $("#search_users_grid_form").serializeArray();
        var obj = {};
        ...
        $("#selectUsersGrid").datagrid('reload', obj);
    }
</script>
<!--//所有自建计划-->
<table id="plan_users_grid" class="easyui-datagrid"  style="width:100%;height:50%"
       data-options="url:'getPlansPage?isAuth=1&if_union=0',method:'get',fitColumns:false,fit:false,idField:'plan_code',checkbox:true,pagination:true,pageNumber:1,pageSize:20,sortOrder:'DESC',sortName:'plan_sdate',singleSelect:false">
