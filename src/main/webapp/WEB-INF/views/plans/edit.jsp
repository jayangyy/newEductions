                    ...
                    <div data-options="region:&#39;center&#39;,title:&#39; &#39;" style="padding: 0px; overflow-x: hidden; width: 100%; height: 987px; display: block; " title="" class="panel-body layout-body">
                        <div id="myaa" class="easyui-accordion accordion" data-options="multiple:true">
                            <div class="panel" style="width:auto;">
                                ...
                                <div id="pXm" title="" data-options="iconCls:&#39;icon-save&#39;" style="overflow: auto; padding-left: 10px;height: 900px; padding-bottom: 10px; display: block; width: auto;" class="panel-body accordion-body">
                                    <div>
                                    ...
                                    <div class="tab-title" style="position:relative;">年度职工培训建议计划</div>
                                    <div id="xmbh_xm" class="sub-tab-title" style="position:relative;">
                                        <!--<span data-bind="text:plan_name"></span>-->
                                    </div>
                                    <table id="tab_sp_jh" class="tab" cellpadding="0" cellspacing="0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <select  name="traintype" id="traintype" label="State:" labelPosition="top" style="width:280px">                                           
                                                    </select>        
                                                </td>
                                                <th style="width: 150px;min-width: 150px;">
                                                    <span>计划类型：</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="plan_name" id="plan_name" value="" style="width:280px;height:70%" class="easyui-textbox" data-options="iconAlign:'left',required:true,onChange:planViewModel.traintypeChange" />
                                                </td>
                                                ...
                                                <td>
                                                    <input id="plan_profid" class="easyui-combobox" name="plan_profid" style="width:280px;"
                                                           data-options="valueField:'id',textField:'name',url:'getProf?id=',method:'get',editable:false,required:true,onSelect:planViewModel.profSelected,onLoadSuccess:planViewModel.profOnSuccess">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 150px;min-width: 150px;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" style="height:70%;width:280px;" name="plan_object" id="plan_object" value="" class="easyui-textbox" data-options="iconAlign:'left',required:true" />
                                                </td>
                                                <th style="width: 150px;">
                                                    <span>培训方式：</span>
                                                </th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" style="height:70%;width:215px;" name="plan_num" id="plan_num" value="" class="easyui-numberbox" data-options="iconAlign:'left',required:true,onChange:numChange"  value="1"/>
                                                    <span id="curpernum" style="width:130px;"></span>
                                                </td>
                                                <th style="width: 150px;">
                                                    <span>培训期数：</span>
                                                </th>
                                                <td>
                                                    <input type="text" style="height:70%;width:280px;" name="plan_periods" id="plan_periods" value="" class="easyui-numberbox" data-options="iconAlign:'left',required:true" />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input class="easyui-numberbox" data-options="precision:2,required:true,editable:false" id="total_fees" name="total_fees" labelPosition="top" style="width:280px;">
                                                </td>
                                                <th style="width: 150px;">
                                                    <span>结算方式：</span>
                                                </th>
                                            ...
                                            <tr>                                               
                                                ...
                                                <td  style="text-align:left;padding-left: 27px;">
                                                    <input type="text" style="height:70%;width:280px;float:left" name="plan_address" id="plan_address" value="" class="easyui-numberbox" data-options="iconAlign:'left',required:true" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 150px;min-width: 150px;">
                                                ...
                                                <td colspan="4">
                                                    <input type="text" style="height:70%;width:110%;" name="plan_cmt" id="plan_cmt" value="" class="easyui-textbox" data-options="iconAlign:'left',required:true" />
                                                </td>
                                            </tr>
                                            <tr style="display: none">
                                                ...
                                                <td colspan="4">
                                                    <input type="text" style="height:70%;width:100%" name="plan_situation" id="plan_situation" value="" class="easyui-textbox" data-options="iconAlign:'left'" />
                                                </td>
                                            </tr>
                                            <tr id="road_tr">
                                                <th style="width: 150px;min-width: 150px;">
...
//                    'queueSizeLimit':1,
                ...
                planViewModel = {
                    ...
                    initPlanUnit: function () {
                        $.getJSON('getUnits?searchType=0&uid=&uname=', function (data) {
                            if (data.length > 0) {
                                $("#plan_unitid").combobox('loadData', data);
                                if (editObj) {
                    ...
                    initExecUnit: function () {
                        $.getJSON('getUnits?searchType=1&uid=&uname=', function (data) {
                            if (data.length > 0) {
                                $('#plan_execunitid').combobox('clear').combobox('loadData', data);
                                if (editObj) {
                    ...
                    init: function () {
                        ...
                        $("#plan_execunitid").combobox({valueField: 'u_id', textField: 'name', onSelect: planViewModel.excunitSelected, editable: false, required: true, onChange: planViewModel.executedChange});
                        ...
                        if (this.$plancode.length >= 0) {
                            ...
                            if (is_station == 'false') {
                                data = [{id: "0", value: "站段培训"}, {id: "1", value: "局培训"}, {id: "2", value: "路外培训"}];
                            } else
                            {
                                data = [{id: "0", value: "站段培训"}];
                            }
                            ...
                            if (this.$plancode == "") {
                                if (data.length > 1) {
                                    $("#traintype").combobox('select', '1');
                                } else {
                                    $("#traintype").combobox('select', '0');
                                }
                                //  $("#plan_num").numberbox('setValue',0);
                                //新增
                            } else {
                                //编辑
                        ...
                        if (record)
                        {
                            ...
                            } else if (record.id == "0")
                            {
                                if (editObj)
                                {
                                    ...
                                    {
                                        $("#plan_unitid").combobox('readonly').combobox('setValue', editObj.plan_unitid).combobox('setText', editObj.plan_unit);
                                    } else
                                    {
                                    ...
                                    {
                                        $("#plan_execunitid").combobox('readonly').combobox('setValue', editObj.plan_execunitid).combobox('setText', editObj.plan_executeunit);
                                    } else
                                    {
                                        $("#plan_execunitid").combobox('readonly').combobox('loadData', []);
                                    }
                                } else
                                {
                                    $("#plan_unitid").combobox({editable: false}).combobox('loadData', [{u_id: '${companyId}', name: '${company}'}]).combobox('select', '${companyId}');
                                    $("#plan_execunitid").combobox({editable: false}).combobox('loadData', [{u_id: '${companyId}', name: '${company}'}]).combobox('select', '${companyId}');
                                }
                                $("#plan_type").combobox({data: [{id: "脱产", text: '脱产'}, {id: "半脱产", text: '半脱产'}], textField: "text", valueField: 'id'})
                            } else
                            {
                                if (editObj)
                                {
                                    ...
                                    if (editObj.plan_unitid)
                                    {
                                        $("#plan_unitid").combobox({editable: true}).combobox('setValue', editObj.plan_unitid).combobox('setText', editObj.plan_unitid);
                                    } else
                                    {
                                        $("#plan_unitid").combobox({editable: true}).combobox('loadData', []);

                                    }
                                    if (editObj.plan_execunitid)
                                    {
                                        $("#plan_execunitid").combobox({editable: true}).combobox('setValue', editObj.plan_execunitid).combobox('setText', editObj.plan_execunitid);
                                    } else
                                    {
                                        $("#plan_execunitid").combobox({editable: true}).combobox('loadData', []);
                                ...
                                $("#plan_type").combobox({data: [{id: "脱产", text: '脱产'}], textField: "text", valueField: 'id'}).combobox('select', '脱产');
                            }
                        }
                    },
                    transfercw: function () {
            ...
            function numChange() {
                var flag = $("#plans_post_type").combobox('getValue');
                if (flag)
                {
