<%-- 
    Document   : authTopUsers
    Created on : 2016-11-21, 10:47:41
    Author     : Jayang
--%>
...
<body>
    <form id="authbackTopForm" style="text-align:left;">
        ...
        <input type="hidden" id="plan_status_cmt" name="plan_status_cmt" value="${passedEnumcmt}"/>
         <input type="hidden" id="plan_status" name="plan_status" value="${passedEnum}"/>
    ...
    <!--//所有移送计划-->
    <table id="plans_topusers_grid" class="easyui-datagrid" 
