    ...
    <div class="easyui-tabs" style="width:100%;height:700px" data-options="fit:true">
        <div title="待办计划" style="padding:10px">
            ...
            <div id="tb">
                <form id="search_form">
                    <div id="grud_div">
                        <a id="btn" href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-s-add'" onclick="appendPlan()">添加计划</a>
                    ...
                    <div>
                        ...
                        <a id="btn" href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-s-edit'" onclick="authTopsBatch()">审核通过</a>
                        <a id="btn" href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-s-edit'" onclick="authpassedBatch()">返拟稿人</a>
                    ...
                    <label for="plan_mainid">
                        主办单位：</lable><input id="plan_mainid" class="easyui-combobox" name="plan_mainid" style="width:150px;"
                        ...
                        <label for="plan_execid">
                            承办单位：</lable><input id="plan_execid" class="easyui-combobox" name="plan_execid" style="width:150px;"
                            ...
                            <label for="planname">
                                培训班名：</lable><input type="text" name="planname" id="planname" class="easyui-textbox" data-options="lable:'计划名称'" />
    ...
    <script type="text/javascript">
        ...
        function planseditSelected(plancode, transfercode) {
            ...
            if ($("#otransfercode").val() != "" && $("#otransfercode").val() != "undefined") {
                ...
                showDialog('edit', '编辑', 'POST', 'patchPlan', true);
            }
        }
        function appendPlan() {
            $("#oplancode").val("");
            $("#otransfercode").val("");
            showDialog('edit', '新增', 'POST', 'putPlan', true);
        }
            ...
            window1.dialog({
                ...
                buttons: [{
                    ...
                    handler: function () {
                        ...
                        debugger;
                        var formData = $("#authTransfersForm").serializeArray();
                        if (users.length == 0 || plans.length == 0) {
                            $.messager.alert('提示','至少选择一条计划！', 'info');
                            return;
                        }
