...
public class Book {
    ...
    private String publishUserUnitId;
    private String memo;
    ...
    /**
     * @param type2Id the type2Id to set
     */
    ...
    /**
     * @param fileurl4 the fileurl4 to set
     */
    ...
    /**
     * @param fileurl5 the fileurl5 to set
     */
    ...
    /**
     * @param fileurl6 the fileurl6 to set
     */
    ...
    /**
     * @return the publishUserUnitId
     */
    public String getPublishUserUnitId() {
        return publishUserUnitId;
    }

    /**
     * @param publishUserUnitId the publishUserUnitId to set
     */
    public void setPublishUserUnitId(String publishUserUnitId) {
        this.publishUserUnitId = publishUserUnitId;
    }
