...
//_b3.pageNumber=0;
//_b4=0;
_b3.pageNumber=1;//显示第几页------吴昌华
_b4=1;//显示共几页------吴昌华
}
if(bb.num){
//bb.num.val(_b3.pageNumber);
bb.num.val(_b3.pageNumber==0?1:_b3.pageNumber);//数据为空时，页码显示为1------吴昌华
}
if(bb.after){
...
_5ac.pagination({total:(opts.pageNumber*opts.pageSize),pageNumber:opts.pageNumber==0?1:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_5ad,_5ae){
...
_726+=((opts.pageNumber==0?1:opts.pageNumber)-1)*opts.pageSize;//防止行号出现负数------吴昌华
}
...
//_7cd.pagination({pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_7ce,_7cf){
	_7cd.pagination({pageNumber:opts.pageNumber==0?1:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_7ce,_7cf){//吴昌华
